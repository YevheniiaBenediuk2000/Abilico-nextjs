    ...
    return (
        <div className="d-flex flex-column min-vh-100">
            ...
            <header className="d-flex justify-content-between align-items-center p-3 border-bottom bg-light shadow-sm position-relative">
                {/* Left: Search */}
                <div className="flex-grow-1 me-3 position-relative" style={{ maxWidth: "600px" }}>
                    <input
                ...
                <div>
                    {!user ? (
                        ...
                        <div className="d-flex align-items-center gap-2">
                            <span className="fw-semibold text-secondary small">{user.email}</span>
            ...
            {isDashboard && (
                <div id="setup-container" style={{ display: "none", marginTop: "1rem" }}>
